//
//  MyLibraryIntrestScreen.swift
//  Source-App
//
//  Created by Nikunj on 01/05/21.
//

import UIKit
import KTCenterFlowLayout

class MyLibraryIntrestScreen: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.getInterests()
        self.shareTitle.text = "Select passions that you’d like to share. Choose up to 3."
...
extension MyLibraryIntrestScreen: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
...
//MARK: - API calleing
extension MyLibraryIntrestScreen{
    func getInterests(){
